...
struct ShortcutEditView: View {
            ...
            Form {
                Section("Overview") {
                    ...
                    Picker("Provider", selection: providerOverrideBinding) {
                        Text("Use default (\(settings.selectedProvider.displayName))").tag(Optional<AIProviderType>.none)
                        ForEach(AIProviderType.allCases) { provider in
                            Text(provider.displayName).tag(Optional<AIProviderType>.some(provider))
                        }
                    }
    ...
    private var providerOverrideBinding: Binding<AIProviderType?> {
        Binding(
